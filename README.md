...
## This lab is in accordance with Sample Airflow Lab 1, but the project name might be misleading it to be Lab2 of airflow.

## mlops-lab2-airflow — simple Airflow pipeline (Wine + KMeans)
